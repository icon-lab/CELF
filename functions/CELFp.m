function [results] = CELFp(S,params,b1plus,mask,varargin)
%CELFp estimates T1, T2, off-resonance and banding free image with
%ellipse fitting constrained center on a line (parfor used)
%   ----inputs----
